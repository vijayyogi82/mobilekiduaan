    ...
    <div class="container">
        <div class="main-header-left">
            ...
            <a class="main-logo" href="index.html">
                <img src="{{asset('assets/admin/img/brand/logo.png')}}" class="header-brand-img desktop-logo"
                    alt="logo">
        ...
        <div class="main-header-center">
            <div class="responsive-logo">
                <a href="index.html"><img src="{{asset('assets/admin/img/brand/logo.png')}}" class="mobile-logo"
                        alt="logo"></a>
                <a href="index.html"><img src="{{asset('assets/admin/img/brand/logo-light.png')}}"
        ...
        <div class="main-header-right">
            ...
            <a class="header-brand2" href="index.html">
                <img src="{{asset('assets/admin/img/brand/logo.png')}}" class="logo-white top-header-logo1">
                <img src="{{asset('assets/admin/img/brand/logo-light.png')}}" class="logo-default top-header-logo2">
            </a>
            ...
            <div class="dropdown main-profile-menu">
                <a class="d-flex" href="">
                    <span class="main-img-user"><img alt="avatar"
                            src="{{asset('assets/admin/img/users/1.jpg')}}"></span>
                </a>
                <div class="dropdown-menu">
                    <div class="header-navheading">
