<div class="main-header side-header header top-header">
    <div class="container">
        <div class="main-header-left">
            <a class="main-header-menu-icon d-lg-none" href="{{route('admin.dashboard')}}" id="mainNavShow"><span></span></a>
            <a class="main-logo" href="{{route('admin.dashboard')}}">

                <img src="{{asset('assets/admin/img/brand/logo.png')}}" class="header-brand-img desktop-logo" alt="logo"
                    style="height: 45px;!important">

                <img src="{{asset('assets/admin/img/brand/logo-light.png')}}"
                    class="header-brand-img desktop-logo theme-logo" alt="logo" style="height: 45px;!important">
            </a>
        </div>
        <div class="main-header-center">
            <div class="responsive-logo">
                <a href="{{route('admin.dashboard')}}">
                    <img src="{{asset('assets/admin/img/brand/logo.png')}}" class="mobile-logo" alt="logo" style="height: 45px;!important">
                </a>
                <a href="{{route('admin.dashboard')}}">
                    <img src="{{asset('assets/admin/img/brand/logo-light.png')}}" class="mobile-logo-dark" alt="logo" style="height: 45px;!important">
                </a>
            </div>
                    ...
                    <div class="main-notification-list">
                        <div class="media new">
                            <div class="main-img-user online"><img alt="avatar"
                                    src="{{asset('assets/admin/img/users/5.jpg')}}"></div>
                        ...
                        <div class="media">
                            <div class="main-img-user"><img alt="avatar"
                                    src="{{asset('assets/admin/img/users/2.jpg')}}"></div>
                            <div class="media-body">
                        ...
                        <div class="media">
                            <div class="main-img-user online"><img alt="avatar"
                                    src="{{asset('assets/admin/img/users/3.jpg')}}"></div>
                            <div class="media-body">
            ...
            <div class="dropdown main-profile-menu">
                <a class="d-flex" href="">
                    <span class="main-img-user">
                        <img alt="avatar" src="{{asset('assets/web/images/profile-img-40.png')}}">
                    </span>
                </a>
                <div class="dropdown-menu">
                    <div class="header-navheading">
