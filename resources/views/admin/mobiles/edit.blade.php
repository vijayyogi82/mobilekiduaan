...
<div class="container">
    <div class="inner-body">
        ...
        <!-- End Page Header -->
        <form action="{{route('admin.mobile.update',$mobile->id)}}" method="post"  enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card custom-card">
                        <div class="card-body">
                            <div class="text-center">
                                ...
                                <button type="submit" name="submit" value="mobile_update" class="btn btn-success m-2">Update</button>
                            </div>
                        </div>
                    </div>
                </div>
