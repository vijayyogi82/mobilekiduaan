...
<div class="container">
    <div class="inner-body">
        ...
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">Mobile Accessories</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Accessory List</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Accessories</li>
                </ol>
            </div>
            <div class="d-flex">
                <div class="justify-content-center">
                    <a href="{{route('admin.mobile.accessories_add')}}" class="btn btn-primary my-2 btn-icon-text text-white">
                        + Add
                    </a>
                </div>
            </div>
                            ...
                            <table class="table table-bordered" id="example2">
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        ...
                                        <td>{{$mobile->model_name ? \Str::limit($mobile->model_name, 50) : ''}}</td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group d-flex">
                                                <a href="{{route('admin.mobile.accessories_edit', $mobile->id) }}" class="btn btn-sm btn-icon btn-primary mx-1"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                                    <i class="ti-pencil"></i>
                                                </a>
                                                <form action="{{ route('admin.mobile.accessories') }}" method="post">
                                                    @csrf
