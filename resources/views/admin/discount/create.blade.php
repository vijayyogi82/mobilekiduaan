        ...
        <div class="page-header">
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Discount Add</li>
                </ol>
            </div>
            <div class="d-flex">
        ...
        <div class="row row-sm">
            ...
            <div class="col-lg-12">
                <div class="card custom-card">
                    <div class="card-body">
                        <form method="POST" action="{{route('admin.discount.save')}}" accept-charset="UTF-8"
                                    ...
                                    <div class="row row-cols-lg-2">
                                        <div class="col-lg-4">
                                            <div class="mb-3 position-relative" style="">
                                                ...
                                                <input class="form-control" name="start_date" type="date" required id="start_date">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="mb-3 position-relative" style="">
                                                ...
                                                <input class="form-control"  name="end_date" type="date" required id="end_date">
                                                <div id="password-error" class="invalid-feedback" style="display: block;"></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="mb-3 position-relative">
                                                <label for="generate"
                                                    class="form-label required">Discount <span class="text-danger">*</span></label>
                                                <input class="form-control" name="discount"
                                                    type="number" required id="discount">
                                    ...
                                    <div class="row row-cols-lg-2">
                                        <div class="col-lg-4">
                                            <div class="mb-3 position-relative">
                                                ...
                                                <input class="form-control" data-counter="6" name="code" type="text" required id="code" readonly>
                                                <div id="password-error" class="invalid-feedback" style="display: block;"></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
