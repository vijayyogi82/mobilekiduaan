            ...
            <div class="col-lg-12">
                <div class="card custom-card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('blogs.store')}}" accept-charset="UTF-8" enctype="multipart/form-data" data-parsley-validate="">
                            @csrf
                                    ...
                                    <div class="row row-cols-lg-2">
                                        <div class="col-lg-12 col-md-12">
                                            <div class="mb-3 position-relative">
                                                ...
                                                <input class="form-control" placeholder="Title" name="title" type="text" id="name" required="required">
                                            </div>
                                        </div>
                                    </div>
