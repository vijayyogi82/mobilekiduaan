                        ...
                        <div class="card-body p-4">
                            <div class="row align-items-center">
                                <div class="offset-lg-4 offset-sm-6 col-lg-8 col-sm-6 col-12 img-bg ">
                                    ...
                                    <p class="tx-white-7 mb-1">You have two projects to finish, you had completed <b
                                            class="text-warning">57%</b> from your montly level,
                                        Keep going to your level
                                </div>
                                <img src="{{asset('assets/admin/img/pngs/work3.png')}}" alt="user-img">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-header border-bottom-0">
                            <div>
                                <label class="main-content-label mb-2">Project Budget</label> <span
                                    class="d-block tx-12 mb-0 text-muted">The Project Budget is a tool used by project
                    ...
                    <div class="card custom-card">
                        <div class="card-header  border-bottom-0 pb-0">
                            <div>
                                ...
                                <span class="d-block tx-12 mt-2 mb-0 text-muted"> project work involves a group of
                                    students investigating . </span>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row mt-1">
                            ...
                            <div class="card-header pt-0 ps-0 pe-0 d-flex">
                                <div>
                                    <label class="main-content-label mb-2">Tasks</label> <span
                                        class="d-block tx-12 mb-2 text-muted">A task is accomplished by a set deadline,
                                        and must contribute toward work-related objectives.</span>
                                </div>
                                <div class="ms-auto">
                                                ...
                                                <div class="demo-avatar-group my-auto float-end">
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{asset('assets/admin/img/users/1.jpg')}}">
                                                    </div>
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{asset('assets/admin/img/users/2.jpg')}}">
                                                    </div>
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{asset('assets/admin/img/users/3.jpg')}}">
                                                    </div>
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{asset('assets/admin/img/users/4.jpg')}}">
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-nowrap">
                                                <div class="demo-avatar-group my-auto float-end">
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{asset('assets/admin/img/users/5.jpg')}}">
                                                    </div>
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{asset('assets/admin/img/users/6.jpg')}}">
                                                    </div>
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{asset('assets/admin/img/users/7.jpg')}}">
                                                    </div>
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{asset('assets/admin/img/users/8.jpg')}}">
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">37<i class=""></i></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-nowrap">
                                                <div class="demo-avatar-group my-auto float-end">
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{asset('assets/admin/img/users/11.jpg')}}">
                                                    </div>
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{asset('assets/admin/img/users/12.jpg')}}">
                                                    </div>
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{asset('assets/admin/img/users/9.jpg')}}">
                                                    </div>
                                                    <div class="main-img-user avatar-sm">
                                                        <img alt="avatar" class="rounded-circle"
                                                            src="{{asset('assets/admin/img/users/10.jpg')}}">
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">37<i class=""></i></td>
                            ...
                            <td class="text-end">
                                <div class="d-inline-block">
                                    <h6 class="mb-2 tx-15 font-weight-semibold">$45.234<i
                                            class="fas fa-level-up-alt ms-2 text-success m-l-10"></i></h6>
                            ...
                            <td class="text-end">
                                <div class="d-inline-block">
                                    <h6 class="mb-2 tx-15 font-weight-semibold">$23.452<i
                                            class="fas fa-level-down-alt ms-2 text-danger m-l-10"></i></h6>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div class="row row-sm">
                        ...
                        <div class="col-6">
                            <img src="{{asset('assets/admin/img/pngs/work.png')}}" alt="image" class="best-emp">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col col-auto">
                            <div class="mt-3">
                                <div class="">
                                    <img alt="" class="ht-50"
                                        src="{{asset('assets/admin/img/media/project-logo.png')}}">
                                </div>
                            </div>
                        </div>
                    </div>
