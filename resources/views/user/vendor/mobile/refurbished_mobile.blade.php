                ...
                <div class="card custom-card overflow-hidden">
                    <div class="card-body">
                        <div class="page-header mt-2 mb-4">
                            <div>
                                <h3 class="main-content-title">Refurbished Mobiles</h3>
                            </div>
                            <div class="d-flex">
                                <div class="justify-content-center">
                                    <a class="btn ripple login-button" href="{{route('vendor.used.mobile')}}"><i class="fa fa-star me-2 pr-2"></i> Add New Mobile</a>
                                    <a class="btn ripple login-button" href="{{Route('vendor.refurbnished.bulk.mobiles.add')}}"><i class="fa fa-star me-2 pr-2"></i> Bulk Upload </a>
                                </div>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-bordered border-bottom" id="example1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$mobile->brand ? $mobile->brand : ''}}</td>
                                        ...
                                        <td class="d-flex inline">
                                            <a href="{{Route('vendor.refurbished_mobile.edit',$mobile->id)}}" class="btn vendor-button">Edit</a>
                                            <form action="{{Route('vendor.refurbished_mobile.delete',$mobile->id)}}" method="post">
                                                @csrf
