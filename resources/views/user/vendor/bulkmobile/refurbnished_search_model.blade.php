                ...
                <div class="mb-3 position-relative">
                    <div class="custom-file-upload">
                        <input class="form-control-file" 
                               name="mobile[{{ $index }}][image][]" 
                               type="file" 
                               id="profile_{{ $index }}" 
                               onchange="displaySelectedImages(this, 'imagePreviewContainer_{{ $index }}')" 
                               multiple>
                        <label for="profile_{{ $index }}" class="file-label" id="fileLabel">
                            <i class="fas fa-cloud-upload-alt"></i> Choose file
                        </label>
                    </div>
                </div>
                <div id="imagePreviewContainer_{{ $index }}"></div>
            </div>
        </div>
        ...
        @if (!empty($mobile->memory_internal))
            <div class="col-md-8">
                ...
                <div class="input-group input-group-sm mb-3">
                    ...
                    <input type="text" class="form-control" value="{{ $mobile->phone_offer }}" name="phone_offer[]" id="phone_offer" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                </div>
