                ...
                <div class="card custom-card overflow-hidden">
                    <div class="card-body">
                        <div class="page-header mt-2 mb-4">
                            <div>
                                <h3 class="main-content-title">Mobile Accessories</h3>
                            </div>
                            <div class="d-flex">
                                <div class="justify-content-center">
                                    <a class="btn ripple login-button" href="{{Route('vendor.accessoriesCreate')}}"><i class="fa fa-star me-2 pr-2"></i> Add New Mobile Accessories</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered border-bottom" id="example1">
                                ...
                                <tbody>
                                   @foreach($products as $mobile)
                                        <tr>
                                            <td>{{$mobile->accessory ? $mobile->brand : ''}}</td>
                                            <td>{{$mobile->accessory ? $mobile->accessory->model_name	 : ''}}</td>
                                            <td>₹{{  $mobile->memory_price }}</td>
                                            <!-- <td>{{ $mobile->views ?? '0' }}</td> -->
                                            <td>{{$mobile->created_at}}</td>
                                            <td class="d-flex inline">
                                                <a href="{{Route('vendor.accessoriesEdit',$mobile->id)}}" class="btn vendor-button">Edit</a>
