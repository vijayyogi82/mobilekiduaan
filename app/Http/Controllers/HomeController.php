...
class HomeController extends Controller
{
    public function index(Request $request)
    {
        ...
        $seo_meta = SeoMeta::where('page_name','home')->first();

        $sliders = Slider::where('status',0)->where('is_deleted',0)->get();
        $bannerlocation1 = Banner::where('page_id', '1')->where('location_id', '1')->where('is_deleted', 0)->first();
        $bannerlocation2 = Banner::where('page_id', '1')->where('location_id', '2')->where('is_deleted', 0)->first();
        $bannerlocation3 = Banner::where('page_id', '1')->where('location_id', '3')->where('is_deleted', 0)->first();

        return view('user.index',compact('mobiles','under_fifteen_thousand','onsale_mobiles','on_sale_footer_mobile','featured_footer_mobile','Trending_mobile','refurbished_mobiles','powerbanks','headphones','earbuds','seo_meta','sliders','bannerlocation1','bannerlocation2','bannerlocation3'));
    }
    ...
    public function product(Request $request, $name,$id){
        ...
        if($product){
          ...
          if($geoLocationVender){
                if($vendorId){
                    $venders = Product::whereIn('vender_id',$geoLocationVender)->where('mobile_id',$product->mobile_id)->with(['Mobile' => function($query) {
    ...
    public function vendor(){
        ...
        $seo_meta = SeoMeta::where('page_name','store')->first();
        return view('user.vendor',compact('vendors','geoLocationDistance','seo_meta'));
    }
    ...
    public function contact(){
        $seo_meta = SeoMeta::where('page_name','contact')->first();
        return view('user.contact',compact('seo_meta'));
    }
    ...
    public function productCategories(Request $request, $category) {
        ...
        $seo_meta = SeoMeta::where('page_name','mobile')->first();
        return view('user.product_categories', compact('products','type','category', 'brands', 'brands_search', 'memory_internals', 'size_search','selfie_cameras','display_sizes','jack','camara','sim','diaplay','seo_meta'));
    }
   ...
   public function mobileAssessries(Request $request,$category){
        ...
        $seo_meta = SeoMeta::where('page_name','accessories')->first();
        // $products = Product::with('accessory')->where('category','accessory')->where('is_deleted','0')->orderBy('created_at', 'DESC')->get();
        return  view('user.mobile_accessories',compact('types','brands','products','category','brands_search','type_search','seo_meta'));
   }
    ...
    public function blog(){
        ...
        $data['seo_meta'] = SeoMeta::where('page_name','blog')->first();
    ...
    public function blog_detail($title,$id) {
